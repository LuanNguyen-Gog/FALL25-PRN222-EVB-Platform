...
public partial class EVBatteryTradingContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Battery>(entity =>
        {
            ...
            entity.HasIndex(e => e.Status, "idx_batteries_status");
        ...
        modelBuilder.Entity<Listing>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.Status, e.CreatedAt }, "idx_listings_status_created").IsDescending(false, true);
        ...
        modelBuilder.Entity<Order>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.Status, e.OrderDate }, "idx_orders_status_date").IsDescending(false, true);
